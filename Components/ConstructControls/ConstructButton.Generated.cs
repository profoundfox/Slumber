//Code for ConstructControls/ConstructButton (Container)
using GumRuntime;
using System.Linq;
using MonoGameGum;
...
partial class ConstructButton : global::Gum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("ConstructControls/ConstructButton");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named ConstructControls/ConstructButton - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ConstructButton(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ConstructButton)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("ConstructControls/ConstructButton", () => 
        {
    ...
    public ConstructButton(InteractiveGue visual) : base(visual)
    {
    }
